 ...
 */
const loginService = param => API.post(AuthUrl, param);

/**
 * The `registerService` function sends a POST request to a specified URL with the provided parameter.
 */
const registerService = param => API.post(AuthUrl, param);

/**
 * The `registerService` function sends a POST request to a specified URL with the provided parameter.
 */
const updateProfileService = param => API.put(updateProfileUrl, param);
